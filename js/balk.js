...
function Balk() {
    ...
    this.createBalk = function(scene) {
        ...
        var frontGeometry = new THREE.BoxGeometry(16, 1, 0.25 );
        ...
        var backGeometry = new THREE.BoxGeometry(16, 1.8, 0.25 );
        ...
        var bottomGeometry = new THREE.BoxGeometry(16, 0.5, 1.5 );
